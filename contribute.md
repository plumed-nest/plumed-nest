...
* __PLUMED version:__ the version of the code used in this project (use -dev to indicate that you use a modified version not officially distributed, e.g. 2.5-dev)
...
<form class="wj-contact" method="POST" action="https://formspree.io/plumed.nest@gmail.com">
  <table>
    ...
    <tr>
      ...
      <td width="600"><input id="version" type="text" name="version" placeholder="examples: 2.4, 2.5-dev (for 2.5 plus personal code)" required></td>
    </tr>
    <tr>
